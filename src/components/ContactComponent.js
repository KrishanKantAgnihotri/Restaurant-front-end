...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        else if (this.state.touched.telnum && (telnum.length > 10 || telnum.length < 3)) {
            errors.telnum = "Tel. Number should be a valid Telephone Number";
        }
        const reg2 = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        if (this.state.touched.email && !reg2.test(String(email).toLowerCase())) {
            errors.email = "Email should be valid one!!";
        }
        return errors;
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname" placeholder="First Name" value={this.state.firstname}
                                        valid={errors.firstname === ""} invalid={errors.firstname !== ""} onChange={this.handleInputChange} onBlur={this.handleBlur('firstname')} />
